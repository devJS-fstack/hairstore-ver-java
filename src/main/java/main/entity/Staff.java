...
public class Staff implements Serializable {
	...
	public String toString() {
		return "Staff [idStaff=" + idStaff + ", surName=" + surName + ", nameStaff=" + nameStaff + ", gender=" + gender
				+ ", phone=" + phone + ", email=" + email + ", cccd=" + cccd + ", store=" + store + ", status=" + status
				+ ", pathImgStaff=" + pathImgStaff + ", idManager=" + idManager + ", typeStaff=" + typeStaff;
	}
	public Staff() {
		super();
	}
