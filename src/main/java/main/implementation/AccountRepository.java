...
public class AccountRepository {
	...
	public TaiKhoan findById(String account, Session session) {
		String hql = "FROM TaiKhoan WHERE account=? AND (idRole = 3 or idRole = 4)";
	...
	public TaiKhoan customFindById(String account, Session session) {
	...
	public Boolean update(TaiKhoan tk, Session session) {
		...
		try {
			...
			transaction.rollback();
			System.out.println("Error while update category: " + e);
		}
