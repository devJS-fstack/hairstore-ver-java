...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/client/css/staff.css">
...
<body>
            ...
            <div class="inner-box">
                ...
                <div class="carousel">
                    <div class="images-wrapper">
                        <img src="client/images/image1.png" class="image img-1 show" alt="" />
                        <img src="client/images/image2.png" class="image img-2" alt="" />
                        <img src="client/images/image3.png" class="image img-3" alt="" />
                    </div>
    ...
    <script src="client/script/staff/login.js"></script>
</body>
