...
<head>
    ...
    <link rel="stylesheet" href="client/css/customer.css">
...
<body>
    <div class="wrapper">
                    ...
                    <div class="adm-page-header">
                        <div class="adm-page-header__content">
                            <div class="adm-page-header__title">
                                <span class="adm-header__label">Khách Hàng</span>
                            </div>
                            <div class="align-right">
                                <button data-toggle="modal" data-target="#add-customer_modal" class="adm-button"
                                    id="btn-AddCustomer">
                    ...
                    <div class="services-list">
                        <div class="mb-3 el-row is-justify-space-between is-align-middle el-row--flex">
                            <div class="adm-input-wrapper filter-search">
                                <div
                                    ...
                                    <input id="search_customer" type="text" placeholder="Tìm kiếm"
                        ...
                        <div>
                            <div class="services-list-header">
                                <h5>Tất Cả Khách Hàng (<span class="all-customer_text">${totalCustomer}</span>)</h5>
                            </div>
                            <div class="services-list-content">
                                <div class="service-list">
                                    <div class="head-row">
                                        <div class="el-row" style="margin-left: -8px; margin-right: -8px; height:32px">
                                            <div class="el-col el-col-24 el-col-sm-7 el-col-lg-10"
                                    ...
                                    <c:forEach items="${customers}" var="c">
                                        <div data-name="${c.nameCustomer}" data-customer=${c.taiKhoan.account}
                                            class="adm-service pointer <c:choose><c:when test="${c.taiKhoan.status eq 'No Active'}">red</c:when></c:choose>"
                                                    ...
                                                    <div class="service-name-col el-col el-col-24 el-col-sm-10"
                                                        ...
                                                        <div class="service-name overflow-ellipsis flex-center">
                                                            ...
                                                            <div class="name-phone">
                                                                ...
                                                                <div class="customer-phone overflow-ellipsis">
                                                                    ${c.taiKhoan.account}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="adm-actions__drop-down">
                                                            <div class="el-dropdown">
                                                                ...
                                                                <ul class="dropdown-menu"
                                                                    ...
                                                                    <li data-customer=${c.taiKhoan.account}
                                                                    ...
                                                                    <li data-customer=${c.taiKhoan.account}
                                                                        class="set-status-customer dropdown-item el-dropdown-menu">
                                                                        <div
                                                                            class="adm-dropdown-item__wrapper is-with-icon">
                                                                            <div class="adm-dropdown-item__icon">
                                                                                <i class="fa-solid fa-lock icon-set-status"
                                                                                    style="font-size: 15px;padding-bottom: 3px;"></i>
                                                                            </div>
                                                                            <div class="adm-dropdown-item__label">
                                                                                <span class="span_set-status">
                                                                                <c:choose>
                                                                                	<c:when test="${c.taiKhoan.status eq 'Active'}">Khóa tài khoản</c:when>
                                                                                	<c:when test="${c.taiKhoan.status eq 'No Active'}">Mở khóa tài khoản</c:when>
                                                                                </c:choose>
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="sidebar-employee">
                                        <div class="sidebar">
                                            <div class="sidebar__header">
                                                <div class="sidebar__header__title semi-bold flex-center name_info">
                                                    Khách Hàng
                                                </div>
                                            ...
                                            <div class="sidebar__content">
                                                <div class="content-empty pt-5">
                                                    ...
                                                    <p>Oops! Hình như Nguyễn Văn Tình chưa đặt lịch cắt tóc lần nào
                                                        trước đây</p>
                                                </div>
                                                <div>
        ...
        <!-- {{!-- Modal --}}
        {{!-- Modal add customer --}} -->
        <div class="modal fade" id="add-customer_modal" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document"
                style="margin-top: 70px; width: 500px ; max-width:500px">
                <div class="modal-content">
                    <div class="el-dialog__header">
                        <span class="adm-modal-title title-customer">
                            Tạo Khách Hàng
                        </span>
                    ...
                    <div class="el-dialog__body">
                        <form class="el-form" id="addCustomerForm" action="employee/add-employee" method="post"
                                                ...
                                                <div class="el-form-item__content">
                                                    <div class="adm-input-wrapper">
                                                        <div
                                                            ...
                                                            <input id="input_phone_cus" type="text" autocomplete="nope"
                                                                maxlength="10" iconstart iconend rows="2" name="email"
                                                                tags class="el-input__inner"
                                            ...
                                            <div class="el-form-item is-success is-required">
                                                ...
                                                <div class="el-form-item__content">
                                                    <div class="adm-input-wrapper">
                                                        <div
                                                            class="el-input el-input__default adm-input adm-input__size-default">
                                                            <input id="input_name_cus" type="text" autocomplete="nope"
                                                                maxlength="100" iconstart iconend rows="2" name="email"
                                                                tags class="el-input__inner" placeholder="Nhập Tên">
                                                        </div>
                                                    </div>
                                                    <div class="adm-form-item__error">
                                                        <!-- {{!-- Bạn vui lòng nhập tên danh mục --}} -->
                                            ...
                                            <div class="el-form-item is-success is-required">
                                                ...
                                                <div class="el-form-item__content">
                                                    <div class="adm-input-wrapper">
                                                        <div
                                                            class="el-input el-input__default adm-input adm-input__size-default">
                                                            <input id="input_email_cus" type="text" autocomplete="nope"
                                                                maxlength="100" iconstart iconend rows="2" name="email"
                                                                tags class="el-input__inner" placeholder="Nhập Email">
                                                        </div>
                                                    </div>
                                                    <div class="adm-form-item__error">
                                                        <!-- {{!-- Bạn vui lòng nhập tên danh mục --}} -->
                    ...
                    <div class="modal-footer" style="justify-content: flex-end !important">
                        ...
                        <button id="confirm-add_customer"
        ...
        <!-- {{!-- Modal edit customer --}} -->
        <div class="modal fade" id="edit-customer_modal" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document"
                style="margin-top: 70px; width: 500px ; max-width:500px">
                <div class="modal-content">
                    ...
                    <div class="el-dialog__body">
                        <form class="el-form" id="editCustomerForm" action="employee/add-employee" method="post"
                            enctype="multipart/form-data">
                            <div class="flex">
                                <div class="flex-grow">
                                    <div class="el-col el-col-24 el-col-sm-24"
                                            ...
                                            <div class="el-form-item is-success is-required">
                                                ...
                                                <div class="el-form-item__content">
                                                    <div class="adm-input-wrapper">
                                                        <div
                                                            class="el-input el-input__default adm-input adm-input__size-default">
                                                            <input id="input_phone_cus_edit" type="text" disabled style="background: #ccc; cursor: not-allowed;"
                                            ...
                                            <div class="el-form-item is-success is-required">
                                                ...
                                                <div class="el-form-item__content">
                                                    <div class="adm-input-wrapper">
                                                        <div
                                                            class="el-input el-input__default adm-input adm-input__size-default">
                                                            <input id="input_name_cus_edit" type="text"
                                            ...
                                            <div class="el-form-item is-success is-required">
                                                ...
                                                <div class="el-form-item__content">
                                                    <div class="adm-input-wrapper">
                                                        <div
                                                            class="el-input el-input__default adm-input adm-input__size-default">
                                                            <input id="input_email_cus_edit" type="text"
                                                                autocomplete="nope" maxlength="100" iconstart iconend
                                                                rows="2" name="email" tags class="el-input__inner"
                    ...
                    <div class="modal-footer" style="justify-content: flex-end !important">
                        <button id="" data-dismiss="modal"
                            class="adm-button adm-button__filled__grey adm-button-size__medium" style="border:none">
                            <span>Đóng</span>
                        </button>
                        <button id="confirm-edit_customer"
                            class="adm-button adm-button__filled__blue adm-button-size__medium ml-3"
                            style="border:none">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="border:none;padding-bottom:0">
                        <h5 class="modal-title" id="alertModalLabel">Xóa Khách Hàng</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body notification-employe_delete" style="padding-bottom:5px">
                        <p>Bạn có chắn chẳn muốn xóa toàn bộ thông tin của khách hàng này bao gồm tài khoản?</p>
                    </div>
...
<script src="client/script/staff/customer.js">
</script>